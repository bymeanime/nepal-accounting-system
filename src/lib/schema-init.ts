...
CREATE TABLE IF NOT EXISTS FiscalYear (
  ...
  adStart TIMESTAMP NOT NULL,
  adEnd TIMESTAMP NOT NULL,
...
CREATE TABLE IF NOT EXISTS Item (
  ...
  vatRate DECIMAL(18,2) NOT NULL DEFAULT 13,
...
CREATE TABLE IF NOT EXISTS PurchaseBill (
  ...
  paidAmount DECIMAL(18,2) NOT NULL DEFAULT 0,
  tdsSection TEXT,
  tdsRate DECIMAL(18,2) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS TaxRule (
  ...
  name TEXT NOT NULL,
  rate DECIMAL(18,2) NOT NULL DEFAULT 0,
  thresholdMin DECIMAL(18,2) NOT NULL DEFAULT 0,
  thresholdMax REAL,
...
CREATE TABLE IF NOT EXISTS PayrollRun (
  ...
  ssfEmployee DECIMAL(18,2) NOT NULL DEFAULT 0,
  ssfEmployer DECIMAL(18,2) NOT NULL DEFAULT 0,
  citEmployee DECIMAL(18,2) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS FixedAsset (
  ...
  acquisitionAdDate TIMESTAMP NOT NULL,
  ...
  depRate DECIMAL(18,2) NOT NULL DEFAULT 0,
